...
for($i_menu=0;$i_menu<count($menu_option[mn_id]);$i_menu++)
{
	...
	if(count($menu_option[mn_id_ref][$i_menu])>0)
	{
		...
		{
			$submenu_option .= "<div ".$nav_active[antiSql2($menu_option[mn_url_ref][$i_menu][$i_submenu])]."><a href=\"".$GLOBALS['access_dir_path_link']."page/".antiSql2($menu_option[mn_url_ref][$i_menu][$i_submenu])."\">".antiSql2($menu_option[mn_name_ref][$i_menu][$i_submenu])."</a></div>";
		...
		$multilayer_menu = "<ul class=\"drop-down\">".$submenu_option."</ul>";
	}
